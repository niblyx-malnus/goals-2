...
/+  *ventio, server, htmx, nooks, fi=webui-feather-icons, html-utils,
    ...
    webui-calendar-day-view-fullday-square-add-event
::
|_  $:  [zid=(unit zid:t) y=@ud m=@ud d=@ud collapse=?]
        =gowl 
        base=(pole @t)
  ...
  ++  fullday-square
    ...
    ;div.relative.min-w-0
      ...
      ;div.absolute.inset-0.z-0
        ...
        ;
      ==
      ;+  (add-event:components:(add-event zid y m d) &)
      ;+  events
    ==
  --
--
