...
const ArchiveInfoPanel: React.FC<{
  goal: Goal,
  rid: string,
}> = ({
  goal,
  ...
  useEffect(() => {
    const fetchLineage = async () => {
      try {
        ...
        const fetchedLineage = await api.getArchiveGoalLineage(pid, rid, gid);
  ...
  useEffect(() => {
    const fetchProgress = async () => {
      try {
        ...
        const fetchedProgress = await api.getArchiveGoalProgress(pid, rid, gid);
...
export default ArchiveInfoPanel;
